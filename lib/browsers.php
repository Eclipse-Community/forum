...
(
	...
	"Chromium" => "Chromium",
	"Android" => "Android",
	"Midori" => "Midori", //This unironically comes with some modern Linux distributions
	"Safari" => "Safari",
	"Konqueror" => "Konqueror",
	"Mozilla" => "Mozilla",
	"Lynx" => "Lynx",
...
(
	...
	"Windows NT 5.2" => "Windows XP x64", //More people use XP x64 than Server 2003 I believe, maybe we can add a 2003 x86 if there's a way to display x86/x64 here. Would also like a way to see if there's a way to display x86/x64 for all operating systems. May also be better to remove this all and let the user pick what OS and browser they use.
	"Windows NT 6.0" => "Windows Vista",
	"Windows NT 6.1" => "Windows 7",
	"Windows NT 6.2" => "Windows 8",
	"Windows NT 6.3" => "Windows 8.1",
	"Windows NT 6.4" => "Windows 10 Beta",
